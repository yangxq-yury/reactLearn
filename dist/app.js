...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Promote = __webpack_require__(134);
	      ...
	      if (pathname === '/programmer' || pathname === '/') {
	        ...
	        layout = _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'row margin-xs' },
	            _react2.default.createElement(
	              'div',
	              { className: 'col-md-9 no-padding-xs' },
	              childrenWithProps
	            ),
	            _react2.default.createElement(
	              'div',
	              { className: 'col-md-3 no-padding-xs' },
...
/***/ function(module, exports) {
	...
	var BASIC_URL = exports.BASIC_URL = 'https://ruby-china.org/api/v3';
	var TOPICS = exports.TOPICS = 'TOPICS';
	var TOPIC = exports.TOPIC = 'TOPIC';

	var received = function received(type, json) {
	  switch (type) {
	    case TOPICS:
	      return {
	        type: type,
	...
	var fetchTopics = exports.fetchTopics = function fetchTopics(options) {
	  return function (dispatch) {
	    console.log(options);
	    var type = 'TOPICS';
	    var url = BASIC_URL + '/topics';
	    var node = '';
	    ...
	    return fetch(url).then(function (response) {
	      ...
	      return dispatch(received(type, json));
	    });
	  };
	};
	...
	var fetchTopic = exports.fetchTopic = function fetchTopic(id) {
	  return function (dispatch) {
	    var type = 'TOPIC';
	    var results = { 'topic': {}, 'replies': [] };
	    fetch(BASIC_URL + '/topics/' + id).then(function (response) {
	      return response.json();
	    }).then(function (json) {
	      results.topic = json.topic;
	      fetch(BASIC_URL + '/topics/' + id + '/replies').then(function (response) {
	        return response.json();
	      }).then(function (json) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DropdownMenu = __webpack_require__(66);
	...
	var Navbar = function (_Component) {
	  ...
	  function Navbar(props) {
	    ...
	    _this.handleClick = function (name) {
	      switch (name) {
	        case "/topics":
	          _this.setState({ topics: true, jobs: false, remote: false, hide: true });
	          break;
	        case "/jobs":
	          _this.setState({ topics: false, jobs: true, remote: false, hide: true });
	          break;
	        case "/remote":
	          _this.setState({ topics: false, jobs: false, remote: true, hide: true });
	          break;
	        default:
	          _this.setState({ topics: false, jobs: false, remote: false, hide: true });
	      }
	    };
	  ...
	  _createClass(Navbar, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'nav',
	          { className: 'navbar navbar-default navbar-fixed-sm', role: 'navigation' },
	          _react2.default.createElement(
	            'div',
	            { className: 'container' },
	            _react2.default.createElement(
	              'div',
	              { className: 'navbar-header', id: 'navbar-header' },
	              _react2.default.createElement(
	                'button',
	                { type: 'button', onClick: function onClick() {
	                    return _this2.toggleDropdown();
	                  }, className: 'bs-navbar-collapse navbar-toggle collapsed' },
	                _react2.default.createElement(
	                  'span',
	                  { className: 'sr-only' },
	                  'Toggle navigation'
	              ...
	              _react2.default.createElement(
	                _reactRouter.Link,
	                { to: '/', activeClassName: 'navbar-brand', onClick: function onClick() {
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: (0, _classnames2.default)("navbar-collapse", { hide: this.state.hide }), id: 'bs-example-navbar-collapse-1' },
	              _react2.default.createElement(
	                'ul',
	                { className: 'nav navbar-nav' },
	                _react2.default.createElement(
	                  'li',
	                  { className: (0, _classnames2.default)({ active: this.state.topics }) },
	                  _react2.default.createElement(
	                    _reactRouter.Link,
	                    { to: '/topics', onClick: function onClick() {
	                        return _this2.handleClick('/topics');
	                      } },
	                    '\u793E\u533A'
	                  )
	                ),
	                _react2.default.createElement(
	                  'li',
	                  { className: (0, _classnames2.default)({ active: this.state.jobs }) },
	                  _react2.default.createElement(
	                    _reactRouter.Link,
	                    { to: '/jobs', onClick: function onClick() {
	                        return _this2.handleClick('/jobs');
	                      } },
	                    '\u62DB\u8058'
	                  )
	                ),
	                _react2.default.createElement(
	                  'li',
	                  { className: (0, _classnames2.default)({ active: this.state.remote }) },
	                  _react2.default.createElement(
	                    _reactRouter.Link,
	                    { to: '/remote', onClick: function onClick() {
	                        return _this2.handleClick('/remote');
	                      } },
	                    '\u8FDC\u7A0B\u5DE5\u4F5C'
	                  )
	                ),
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    'a',
	                    { href: 'https://gems.ruby-china.org/', target: '_blank' },
	                    'Gems'
	                  )
	                )
	              ),
	              _react2.default.createElement(_DropdownMenu2.default, { onClick: this.handleClick.bind(this) })
	            )
	          )
	        )
	      );
	    ...
	    _this.handleClick = function (name) {
	      ...
	      switch (name) {
	        case "/topics/new":
	          ...
	          break;
	        default:
	          _this.setState({ open: false, menuopen: false });
	      }
	    };
	  ...
	  _createClass(Home, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'li',
	          { className: (0, _classnames2.default)("dropdown", { open: this.state.open }) },
	          _react2.default.createElement(
	            'a',
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                _reactRouter.Link,
	                { to: '/topics/new', onClick: function onClick() {
	                    return _this2.handleClick('/topics/new');
	                  } },
	                '\u53D1\u5E03\u65B0\u8BDD\u9898'
	              )
	            )
	        ...
	        _react2.default.createElement(
	          'li',
	          { className: (0, _classnames2.default)("dropdown", { open: this.state.menuopen }) },
	          _react2.default.createElement(
	            'a',
	            { onClick: function onClick() {
	                return _this2.toggleDropdownMenu();
	              }, className: 'dropdown-toggle' },
	            'Name',
	            _react2.default.createElement('span', { className: 'caret' })
	          ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	(function () {
		...
		} else if ("function" === 'function' && _typeof(__webpack_require__(68)) === 'object' && __webpack_require__(68)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PatternUtils = __webpack_require__(76);
	...
	var _withRouter2 = __webpack_require__(110);

	var _withRouter3 = _interopRequireDefault(_withRouter2);

	var _IndexRedirect2 = __webpack_require__(111);

	var _IndexRedirect3 = _interopRequireDefault(_IndexRedirect2);

	var _IndexRoute2 = __webpack_require__(113);
	...
	var _useRoutes2 = __webpack_require__(118);
	...
	var _RoutingContext2 = __webpack_require__(119);
	...
	var _useRouterHistory2 = __webpack_require__(124);
	...
	var _hashHistory2 = __webpack_require__(129);

	var _hashHistory3 = _interopRequireDefault(_hashHistory2);

	var _createMemoryHistory2 = __webpack_require__(121);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _deprecate = __webpack_require__(93);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isActive2 = __webpack_require__(101);

	var _isActive3 = _interopRequireDefault(_isActive2);

	var _getComponents = __webpack_require__(102);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createRouterHistory = __webpack_require__(128);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _useRouterHistory = __webpack_require__(124);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Promote = function (_Component) {
	  _inherits(Promote, _Component);

	  function Promote() {
	    _classCallCheck(this, Promote);

	    return _possibleConstructorReturn(this, (Promote.__proto__ || Object.getPrototypeOf(Promote)).apply(this, arguments));
	  }
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'a',
	              { href: 'http://ruby-china.liuzhen.me', target: '_blank' },
	              'RubyChina \u514B\u9686 | React.js'
	            )
	          ),
	          _react2.default.createElement(
	            'li',
	            ...
	            _react2.default.createElement(
	              'a',
	              { href: 'http://v2ex.liuzhen.me', target: '_blank' },
	              'V2EX \u514B\u9686 | Vue.js'
	            )
	          ),
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'a',
	              { href: 'http://liuzhen.me', target: '_blank' },
	              'Rina\'s Blog'
	            )
	          ),
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'a',
	              { href: 'http://ecssz.com/', target: '_blank' },
	              'ECS'
	            )
	          ),
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'a',
	              { href: 'https://github.com/liuzhenangel/react-ruby-china', target: '_blank' },
	              'RubyChina Clone Github'
	            )
	          ),
	          _react2.default.createElement(
	            'li',
	            ...
	            _react2.default.createElement(
	              'a',
	              { href: 'https://github.com/liuzhenangel/v2ex_frontend', target: '_blank' },
	              'V2EX Clone Github'
	            )
	          ),
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'a',
	              { href: 'https://github.com/liuzhenangel', target: '_blank' },
	              'Rina\'s GitHub'
	            )
	          )
	        )
